    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        <motion.div
          ...
          className="max-w-8xl mx-auto mb-12"
        >
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {features.map((feature, index) => (
                <motion.div
                  ...
                  className="bg-white rounded-2xl p-8 shadow hover:shadow-lg transition-shadow border border-orange-100/50"
                >
        ...
        >
          <div className="bg-slate-900 rounded-2xl p-8 text-center shadow">
