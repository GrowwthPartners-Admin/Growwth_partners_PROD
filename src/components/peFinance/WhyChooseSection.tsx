...
const WhyChooseSection = () => {
  return (
    <section className="py-20 lg:py-28 bg-gradient-to-br from-slate-900 via-emerald-950 to-slate-900 text-white overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mb-12">
            {reasons.map((reason, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className={`p-6 lg:p-8 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 hover:border-emerald-500/50 transition-all duration-300 group ${
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="p-8 lg:p-10 bg-gradient-to-r from-emerald-600/20 to-teal-600/20 rounded-3xl border border-emerald-500/30 text-center"
          >
