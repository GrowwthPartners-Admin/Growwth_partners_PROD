        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16">
              ...
              <div className="space-y-4">
                {idealFor.map((item, index) => (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    className="flex items-center gap-4 p-4 bg-white dark:bg-slate-800/50 rounded-xl border border-slate-200 dark:border-slate-700 hover:border-emerald-300 dark:hover:border-emerald-700 hover:shadow-md transition-all duration-300"
                  >
                    <div className="p-2.5 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-lg text-white shrink-0">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <div className="bg-gradient-to-br from-emerald-600 to-teal-600 rounded-3xl p-8 lg:p-10 text-white h-full">
                ...
                <div className="space-y-5 mb-10">
                  {questions.map((question, index) => (
                    ...
                    >
                      <span className="text-2xl font-bold text-emerald-200">{index + 1}</span>
