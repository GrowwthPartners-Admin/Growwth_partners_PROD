      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-7xl mx-auto mb-16 space-y-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {suitableFor.slice(0, 3).map((item, index) => (
              <motion.div
                key={index}
          ...
          <div className="flex flex-col md:flex-row justify-center gap-6">
            {suitableFor.slice(3).map((item, i) => {
              ...
              return (
                ...
                >
                  <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-md hover:shadow-lg transition-all duration-300 h-full">
                    <div className="w-12 h-12 bg-gradient-to-br from-orange-500 to-amber-500 rounded-xl flex items-center justify-center mb-4">
                      <item.icon className="w-6 h-6 text-white" />
                    </div>
                    <p className="text-gray-700 font-medium">{item.text}</p>
        ...
        >
          <div className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-3xl p-8 md:p-12 border border-orange-100 shadow">
            ...
            <p className="text-center text-xl font-semibold text-gray-900">
              You are ready for{" "}
              <span className="text-brand-orange">Part-Time CFO support</span>.
            </p>
          </div>
        </motion.div>
      </div>
