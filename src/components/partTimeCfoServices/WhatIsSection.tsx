      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-gray-600 leading-relaxed">
            A Part-Time CFO is a senior finance professional who works with your business for a defined
            number of days or hours per month, delivering strategic financial oversight, governance, and
            planning, without being a full-time employee.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-xl text-white max-w-3xl mx-auto leading-relaxed">
            ...
            <span className="text-brand-orange font-semibold">CFO-level thinking</span>, not just
