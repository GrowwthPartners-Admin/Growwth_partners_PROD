...
import { ArrowRight, Play, TrendingUp, BarChart3, Target } from "lucide-react";
...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-gradient-to-br from-emerald-950 via-teal-900 to-cyan-900">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium text-emerald-300">Ryzup.ai Forecasting</span>
            </motion.div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button
                ...
                className="bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white px-8 py-6 text-lg rounded-xl shadow-lg shadow-emerald-500/25 font-semibold group"
              >
          ...
          >
            ...
            <div className="relative bg-white/10 backdrop-blur-xl rounded-3xl p-6 border border-white/20 shadow-2xl">
              ...
              <div className="grid grid-cols-3 gap-4 mt-6">
                {[
                  { icon: TrendingUp, label: "Revenue", value: "+24%", color: "text-emerald-400" },
                  { icon: BarChart3, label: "Cash Flow", value: "AED 2.4M", color: "text-teal-400" },
                  { icon: Target, label: "Runway", value: "18 mo", color: "text-cyan-400" },
                ].map((metric, i) => (
                  <motion.div
                    key={i}
                    initial={{ opacity: 0, y: 20 }}
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <div className="text-emerald-400 text-xs">98% confidence</div>
                </div>
              </div>
            </motion.div>
          </motion.div>
