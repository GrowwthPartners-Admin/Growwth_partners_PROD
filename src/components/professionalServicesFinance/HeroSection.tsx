        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              ...
              <span className="text-indigo-300 text-sm font-medium">Professional Services Finance</span>
            </motion.div>
            ...
            <motion.p
              ...
              className="text-xl sm:text-2xl text-indigo-100 font-medium mb-4"
            >
            ...
            >
              <Button
                ...
                className="group bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-600 text-white px-8 py-6 text-lg rounded-xl shadow-lg shadow-indigo-500/25 hover:shadow-indigo-500/40 transition-all duration-300"
              >
          ...
          >
            <div className="relative">
              ...
              <motion.div
                ...
                className="absolute -bottom-6 -left-6 bg-gradient-to-br from-indigo-500 to-purple-500 rounded-2xl p-4 shadow-xl"
              >
              ...
              >
                <span className="text-indigo-300 font-semibold">Services Specialists</span>
              </motion.div>
            </div>
          </motion.div>
        </div>
