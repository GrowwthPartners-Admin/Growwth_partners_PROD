      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-slate-600 max-w-3xl mx-auto">
            AI CFO services are ideal for businesses that outgrow spreadsheet-based
            reporting
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          {idealFor.slice(0, 3).map((item, index) => (
            <motion.div
              ...
              className="bg-white rounded-xl p-6 shadow hover:shadow-lg transition-shadow border border-slate-100"
            >
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-6 mb-12">
          {idealFor.slice(3).map((item, index) => (
            <motion.div
              ...
              className="w-full max-w-md bg-white rounded-xl p-6 shadow hover:shadow-lg transition-shadow border border-slate-100"
            >
              <div className="w-14 h-14 bg-gradient-to-br from-orange-100 to-amber-100 rounded-xl flex items-center justify-center mb-4">
                <item.icon className="w-7 h-7 text-orange-500" />
              </div>
        ...
        {/* Call-out Box (unchanged) */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          className="max-w-4xl mx-auto bg-gradient-to-r from-slate-900 to-slate-800 shadow rounded-2xl p-8 text-white"
        >
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="text-lg font-medium mb-4">
                If your business relies on spreadsheets that are outdated the moment
                they're created, AI CFO services provide a significant advantage.
              </p>
