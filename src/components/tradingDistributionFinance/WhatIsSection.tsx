            ...
            <div className="space-y-4">
              {focusAreas.map((area, index) => (
                <motion.div
                  ...
                  className="group flex items-start gap-4 p-4 rounded-xl bg-slate-50 hover:bg-emerald-50 border border-slate-100 hover:border-emerald-200 transition-all duration-300"
                >
