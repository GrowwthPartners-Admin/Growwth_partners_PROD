      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Our Outsourced Payroll services are built on accuracy, compliance, and accountability.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {deliveryAreas.map((area, index) => (
            <motion.div
              ...
              className="group relative p-6 bg-gradient-to-br from-slate-50 to-white rounded-2xl border border-slate-200 hover:border-orange-300 hover:shadow-xl transition-all duration-300"
            >
