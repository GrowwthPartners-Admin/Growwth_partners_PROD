      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            If payroll is consuming leadership time or causing repeated corrections, outsourcing is the most efficient solution.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {idealUsers.map((user, index) => (
            <motion.div
              ...
              className="group p-6 bg-white rounded-2xl border border-slate-200 hover:border-orange-300 hover:shadow-lg hover:shadow-orange-100/50 transition-all duration-300"
            >
