      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-slate-600 leading-relaxed">
            A Fractional CFO is a senior finance professional who works with your
            business on a part-time, ongoing basis, providing high-impact
        ...
        >
          <div className="bg-gradient-to-br from-slate-50 to-orange-50 rounded-3xl p-8 md:p-12 border border-slate-100">
            <h3 className="text-xl md:text-2xl font-bold text-slate-900 mb-8 text-center">
              Unlike accountants or finance managers, a Fractional CFO focuses
              on:
            </h3>
