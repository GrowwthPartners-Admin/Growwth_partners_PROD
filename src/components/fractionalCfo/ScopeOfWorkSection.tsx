...
const ScopeOfWorkSection = () => {
  const scopeItems = [
    ...
    },
    {
      ...
      items: ["Burn-rate tracking", "Working capital management", "Liquidity stress testing"],
    },
    {
      number: "03",
      icon: BarChart3,
      title: "Management & Board Reporting",
      items: ["Monthly MIS packs", "KPI dashboards", "Board-level insights"],
    },
    {
      number: "04",
      icon: Briefcase,
      title: "Fundraising & Investor Readiness",
      items: ["Financial models", "Pitch deck financials", "Due diligence support"],
    },
    {
      number: "05",
      icon: Settings,
        ...
        <div className="max-w-8xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {scopeItems.slice(0, 3).map((scope, index) => (
                <motion.div
                  key={scope.number}
                  initial={{ opacity: 0, y: 30 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  ...
                  className="bg-white/5 backdrop-blur-sm rounded-2xl shadow p-6 border border-white/10 hover:border-orange-500/30 transition-all duration-300"
                >
                  <div className="flex items-center gap-4 mb-6">
                    <div className="text-4xl font-bold text-orange-500/30">{scope.number}</div>
            ...
            <div className="flex flex-col lg:flex-row justify-center gap-6">
              {scopeItems.slice(3).map((scope, i) => {
                ...
                return (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ delay: index * 0.1 }}
                    className="w-full lg:max-w-[520px] bg-white/5 backdrop-blur-sm shadow rounded-2xl p-6 border border-white/10 hover:border-orange-500/30 transition-all duration-300"
                  >
                    <div className="flex items-center gap-4 mb-6">
                      <div className="text-4xl font-bold text-orange-500/30">{scope.number}</div>
                      <div className="w-12 h-12 bg-gradient-to-br from-orange-500 to-amber-500 rounded-xl flex items-center justify-center">
