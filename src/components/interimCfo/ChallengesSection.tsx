import { 
  AlertTriangle, FileX, Shield, Wallet, Users, Scale,
  CheckCircle, Clock, BarChart3, TrendingDown, ArrowRight
} from "lucide-react";

const ChallengesSection = () => {
  const risks = [
    { icon: FileX, text: "Delayed or inaccurate financial reporting" },
    { icon: Shield, text: "Weak internal controls and governance" },
    { icon: Wallet, text: "Cash flow mismanagement" },
    { icon: Users, text: "Loss of investor and stakeholder confidence" },
    { icon: Scale, text: "Increased compliance and audit risk" }
  ];

  const benefits = [
    { icon: CheckCircle, text: "Immediate access to a senior Interim CFO" },
    { icon: Shield, text: "Full ownership of finance leadership responsibilities" },
    { icon: BarChart3, text: "Clear stabilisation and transition roadmap" },
    { icon: Clock, text: "Improved reporting accuracy and timeliness" },
    { icon: TrendingDown, text: "Reduced financial and operational risk" }
  ];
            ...
            <div className="bg-gradient-to-br from-red-50 via-orange-50 to-amber-50 rounded-3xl p-8 lg:p-10 border border-red-100">
              ...
              <div className="space-y-4">
                {risks.map((risk, index) => (
                  ...
                  >
                    ...
                    <span className="text-gray-700 font-medium">{risk.text}</span>
                  </div>
                ))}
              </div>
              ...
              <div className="mt-8 p-4 bg-white/80 rounded-xl border border-orange-200">
                <p className="text-orange-800 font-medium text-center">
                  An Interim CFO ensures <span className="font-bold">continuity, control, and credibility</span>.
                </p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 rounded-3xl p-8 lg:p-10 border border-green-100">
              ...
              <div className="mt-8 p-4 bg-gradient-to-r from-green-500 to-emerald-500 rounded-xl text-white">
                <p className="font-medium text-center">
                  Engagements are <span className="font-bold">time-bound, outcome-driven</span>, and focused on continuity.
                </p>
              </div>
            </div>
          </div>
