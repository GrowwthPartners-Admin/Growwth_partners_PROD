...
export const StopGuessingSection = () => {
  ...
  const solutions = [
    {
      icon: Clock,
      text: "See your cash runway in real time, not once a quarter",
    },
    {
      icon: TrendingUp,
      text: "Understand how each decision changes your next 6 to 18 months",
    },
    {
      icon: LineChart,
      text: "Replace one-off Excel files with living, breathing forecasts",
    },
  ];
      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            With RyzUp, AI forecasting for Singapore businesses turns into a
            daily, real-time view of your cash, revenue, and runway.
          </p>
        </motion.div>
