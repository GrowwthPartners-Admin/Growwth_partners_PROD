...
import { ArrowRight, Play, Shield, Sparkles, Lock } from "lucide-react";
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tight text-gray-900 leading-[1.1]">
              Smart AI for <br className="hidden lg:block" />
            ...
            <p className="text-lg md:text-xl text-gray-600 leading-relaxed max-w-2xl mx-auto lg:mx-0">
              Ryzup.ai gives UAE finance teams continuous monitoring of spreadsheets and accounting data. 
              Strengthen controls, prevent fraud, and streamline regulatory tasks with privacy-safe automation 
              designed for AI compliance in the UAE and always-on AI risk monitoring.
            </p>
            ...
            <div className="relative w-full max-w-[600px] group">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-amber-200/50 bg-white transform transition-transform duration-500 hover:scale-[1.01]">
                ...
                <img 
                  ...
                  alt="Ryzup.ai Risk & Compliance Dashboard" 
              ...
              >
                ...
                <div>
                  <div className="text-[10px] text-gray-500 uppercase font-bold tracking-wider">Compliance</div>
